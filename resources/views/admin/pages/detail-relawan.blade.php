...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="mb-2 page-title">Detail Relawan {{ $caleg->name }}</h2>
                                                    ...
                                                    <form action="/detail-relawan/{{ $data->id }}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div hidden class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $datatps->id }}"
                                                                    name="id_detail_tps" class="form-control"
                                                                    id="recipient-name" required>
                                                            </div>
                            ...
                            <div class="modal fade" id="addModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="/detail-relawan" method="POST">
                                            @csrf
                                            @method('POST')
                                            <div class="modal-body">
                                                ...
                                                <div hidden class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $datatps->id }}" name="id_detail_tps"
                                                        class="form-control" id="recipient-name" required>
                                                </div>
