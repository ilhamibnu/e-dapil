                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/detail-tps/{{ $data->id }}" class="btn btn-success btn-sm">Detail</a>
                                                    ...
                                                    <form action="/detail-desa/{{ $data->id }}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <div hidden class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $detailkecamatan->id }}" name="id_detail_kecamatan" class="form-control" id="recipient-name" required>
                                                            </div>
